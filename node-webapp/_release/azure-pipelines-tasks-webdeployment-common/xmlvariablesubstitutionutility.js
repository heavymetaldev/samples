...
exports.substituteXmlVariables = exports.substituteAppSettingsVariables = void 0;
...
function substituteValueinParameterFile(parameterFilePath, parameterSubValue) {
    ...
    var fileBuffer = fs.readFileSync(parameterFilePath);
...
function substituteAppSettingsVariables(folderPath, isFolderBasedDeployment, fileName) {
...
function substituteXmlVariables(configFile, tags, variableMap, parameterFilePath) {
...
exports.substituteXmlVariables = substituteXmlVariables;
function updateXmlConfigNodeAttribute(xmlNode, variableMap, replacableTokenValues, npmDomUtiltiyInstance) {
